% \date{\today}
\date{}
\title{\vspace{-1cm}Codebook- Team bits\_dont\_lie\\IIT Delhi, India}
...
% \subsection{Format c++} % Stanford
% \lstinputlisting[language=c++]{Format.c++}
...
\subsection{FFT_Complex} % Stanford
...
\lstinputlisting[language=c++]{Convex_hull_trick.c++}
